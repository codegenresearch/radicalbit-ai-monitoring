...
class Model:
    ...
    def load_reference_dataset(
        ...
        :param object_name: The optional name of the object uploaded to S3.
        :param aws_credentials: AWS credentials used to connect to S3 bucket.
        :param separator: Optional value to define separator used inside CSV file.
    ...
    def bind_reference_dataset(
        ...
        try:
            file_headers = self._get_file_headers(s3_client, url_parts, separator)
            required_headers = self._required_headers()
    ...
    def update_features(self, new_features: List[ColumnDefinition]) -> None:
        ...
        :param new_features: List of new features to be set for the model.
        """
    ...
    def _get_file_headers(self, s3_client: boto3.client, url_parts: List[str], separator: str) -> List[str]:
