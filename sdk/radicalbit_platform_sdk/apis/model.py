...
class Model:
    ...
    def update_features(self, new_features: List[ColumnDefinition]) -> None:
        ...
        self.__update_model_definition()
    ...
    def __update_model_definition(self) -> None:
        """Update the model definition with the new features"""
        updated_definition = ModelDefinition(
            uuid=self.__uuid,
            name=self.__name,
        ...
        self.__definition = updated_definition